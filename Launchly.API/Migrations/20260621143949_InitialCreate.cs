        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailVerifyExpiry = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VisitorLogs_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_TenantId_ServiceId_StartTime",
                table: "Appointments",
                columns: new[] { "TenantId", "ServiceId", "StartTime" },
                unique: true,
                filter: "\"DeletedAt\" IS NULL AND \"Status\" != 3");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitorLogs_TenantId_VisitedAt",
                table: "VisitorLogs",
                columns: new[] { "TenantId", "VisitedAt" });
        }
